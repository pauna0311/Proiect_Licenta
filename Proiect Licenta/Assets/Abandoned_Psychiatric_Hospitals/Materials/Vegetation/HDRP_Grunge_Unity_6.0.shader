...
Shader "AE/Grunge"
{
	Properties
	{
		...
		_Base_Color_Grtunge_Scale("Base_Color_Grtunge_Scale", Range( 1 , 64)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _Base_Color_Grtunge_Scale;
						...
						)
			{
				...
				float2 texCoord68 = packedInput.ase_texcoord6.xy * _Tiling_Main_Texture + float2( 0,0 );
				float4 temp_output_78_0 = ( _Tint * tex2D( _Base_Color, texCoord68 ) );
				float4 temp_cast_0 = (1.0).xxxx;
				float2 temp_cast_1 = (( 2.0 / _Base_Color_Grtunge_Scale )).xx;
				float3 ase_positionWS = GetAbsolutePositionWS( PositionRWS );
				float4 triplanar67 = TriplanarSampling67( _Base_Color_Grtunge, ase_positionWS, NormalWS, 1.0, temp_cast_1, 1.0, 0 );
				float temp_output_66_0 = ( 1.0 - _Grunge_Texture_Opacity );
				float4 temp_cast_2 = (temp_output_66_0).xxxx;
				float4 lerpResult72 = lerp( triplanar67 , temp_cast_2 , temp_output_66_0);
				#ifdef _GRUNGE_TEXTURE_ON
				float4 staticSwitch77 = lerpResult72;
				#else
				float4 staticSwitch77 = _Grunge_Tint;
				#endif
				float2 temp_cast_4 = (( 2.0 / _GrungeScale )).xx;
				float4 triplanar54 = TriplanarSampling54( _Grunge, ase_positionWS, NormalWS, 1.0, temp_cast_4, 1.0, 0 );
				#if defined( _GRUNGECHANNEL_R )
				float staticSwitch59 = triplanar54.x;
				#elif defined( _GRUNGECHANNEL_G )
				float staticSwitch59 = triplanar54.g;
				#elif defined( _GRUNGECHANNEL_B )
				float staticSwitch59 = triplanar54.b;
				#else
				float staticSwitch59 = triplanar54.g;
				#endif
				float clampResult69 = clamp( (0.0 + (staticSwitch59 - _Grunge_Min) * (1.0 - 0.0) / (_Grunge_Max - _Grunge_Min)) , 0.0 , 1.0 );
				float4 lerpResult79 = lerp( temp_cast_0 , staticSwitch77 , ( _Grunge_Opacity * clampResult69 ));
				#ifdef _GRUNGE_ON_ON
				float4 staticSwitch87 = ( temp_output_78_0 * lerpResult79 );
				#else
				float4 staticSwitch87 = temp_output_78_0;
				#endif
				
				float3 unpack84 = UnpackNormalScale( tex2D( _Normal, texCoord68 ), _Normal_Scale );
				unpack84.z = lerp( 1, unpack84.z, saturate(_Normal_Scale) );
				
				float4 tex2DNode80 = tex2D( _Metallic_Smoothness, texCoord68 );
				
				surfaceDescription.BaseColor = staticSwitch87.rgb;
				surfaceDescription.Normal = unpack84;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = tex2DNode80.rgb.x;
				...
				surfaceDescription.Smoothness = ( _Smoothness * tex2DNode80.a );
				surfaceDescription.Occlusion = tex2D( _AmbientOcclusion, texCoord68 ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord68 = packedInput.ase_texcoord2.xy * _Tiling_Main_Texture + float2( 0,0 );
				float4 temp_output_78_0 = ( _Tint * tex2D( _Base_Color, texCoord68 ) );
				float4 temp_cast_0 = (1.0).xxxx;
				float2 temp_cast_1 = (( 2.0 / _Base_Color_Grtunge_Scale )).xx;
				float3 ase_positionWS = packedInput.ase_texcoord3.xyz;
				float3 ase_normalWS = packedInput.ase_texcoord4.xyz;
				float4 triplanar67 = TriplanarSampling67( _Base_Color_Grtunge, ase_positionWS, ase_normalWS, 1.0, temp_cast_1, 1.0, 0 );
				float temp_output_66_0 = ( 1.0 - _Grunge_Texture_Opacity );
				float4 temp_cast_2 = (temp_output_66_0).xxxx;
				float4 lerpResult72 = lerp( triplanar67 , temp_cast_2 , temp_output_66_0);
				#ifdef _GRUNGE_TEXTURE_ON
				...
				#endif
				float2 temp_cast_4 = (( 2.0 / _GrungeScale )).xx;
				float4 triplanar54 = TriplanarSampling54( _Grunge, ase_positionWS, ase_normalWS, 1.0, temp_cast_4, 1.0, 0 );
				#if defined( _GRUNGECHANNEL_R )
				float staticSwitch59 = triplanar54.x;
				#elif defined( _GRUNGECHANNEL_G )
				float staticSwitch59 = triplanar54.g;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord68 = packedInput.ase_texcoord4.xy * _Tiling_Main_Texture + float2( 0,0 );
				float3 unpack84 = UnpackNormalScale( tex2D( _Normal, texCoord68 ), _Normal_Scale );
				unpack84.z = lerp( 1, unpack84.z, saturate(_Normal_Scale) );
		...
		Pass
		{
				...
				)
			{
				...
				SmoothSurfaceDescription surfaceDescription = (SmoothSurfaceDescription)0;
				float2 texCoord68 = packedInput.ase_texcoord3.xy * _Tiling_Main_Texture + float2( 0,0 );
				float3 unpack84 = UnpackNormalScale( tex2D( _Normal, texCoord68 ), _Normal_Scale );
				unpack84.z = lerp( 1, unpack84.z, saturate(_Normal_Scale) );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord68 = packedInput.ase_texcoord8.xy * _Tiling_Main_Texture + float2( 0,0 );
				float4 temp_output_78_0 = ( _Tint * tex2D( _Base_Color, texCoord68 ) );
				float4 temp_cast_0 = (1.0).xxxx;
				float2 temp_cast_1 = (( 2.0 / _Base_Color_Grtunge_Scale )).xx;
				float3 ase_positionWS = GetAbsolutePositionWS( PositionRWS );
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.BreakToComponentsNode;48;198.9263,-58.07031;Inherit;False;FLOAT;1;0;FLOAT;0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.RangedFloatNode;49;-654.407,490.8528;Inherit;False;Property;_GrungeScale;GrungeScale;12;0;Create;True;0;0;0;False;0;False;1;8.2;1;64;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-526.407,298.8528;Inherit;False;Constant;_Float0;Float 0;2;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;51;-622.407,106.8528;Inherit;True;Property;_Grunge;Grunge;1;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.WorldPosInputsNode;52;-558.407,-117.1472;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleDivideOpNode;53;-286.407,218.8528;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;54;-126.407,-5.147232;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;-1;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;55;-542.407,-757.1472;Inherit;False;Constant;_Float2;Float 0;2;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;-670.407,-565.1472;Inherit;False;Property;_Base_Color_Grtunge_Scale;Base_Color_Grtunge_Scale;13;0;Create;True;0;0;0;False;0;False;1;8.2;1;64;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;57;225.593,-293.1472;Inherit;False;Property;_Grunge_Min;Grunge_Min;19;0;Create;True;0;0;0;False;0;False;0.06147235;0.06147235;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;58;225.593,-197.1472;Inherit;False;Property;_Grunge_Max;Grunge_Max;18;0;Create;True;0;0;0;False;0;False;0.3000374;0.253;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;59;305.593,26.85277;Inherit;False;Property;_GrungeChannel;GrungeChannel;15;0;Create;True;0;0;0;False;0;False;0;1;1;True;;KeywordEnum;3;R;G;B;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;60;337.593,-757.1472;Inherit;False;Property;_Grunge_Texture_Opacity;Grunge_Texture_Opacity;17;0;Create;True;0;0;0;False;0;False;1;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;61;-462.407,-997.1472;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleDivideOpNode;62;-302.407,-837.1472;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;63;-286.407,-1221.147;Inherit;True;Property;_Base_Color_Grtunge;Base_Color_Grtunge;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector2Node;64;-670.407,666.8528;Inherit;False;Property;_Tiling_Main_Texture;Tiling_Main_Texture;6;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TFHCRemapNode;65;625.593,-5.147232;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;66;593.593,-837.1472;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;67;49.59302,-1093.147;Inherit;True;Spherical;World;False;Top Texture 1;_TopTexture1;white;-1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;68;-382.407,634.8528;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;69;833.593,-5.147232;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;70;689.593,-117.1472;Inherit;False;Property;_Grunge_Opacity;Grunge_Opacity;16;0;Create;True;0;0;0;False;0;False;0.6238509;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;71;561.593,-597.1472;Inherit;False;Property;_Grunge_Tint;Grunge_Tint;14;0;Create;True;0;0;0;False;0;False;0.5566038,0.5566038,0.5566038,0;0.8396226,0.8396226,0.8396226,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.LerpOp;72;801.593,-885.1472;Inherit;True;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ColorNode;73;33.59302,218.8528;Inherit;False;Property;_Tint;Tint;7;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;74;-30.40698,458.8528;Inherit;True;Property;_Base_Color;Base_Color;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;75;1073.593,-101.1472;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;705.593,-229.1472;Inherit;False;Constant;_Float1;Float 1;12;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;77;1105.593,-709.1472;Inherit;True;Property;_Grunge_Texture;Grunge_Texture;11;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;78;401.593,330.8528;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;79;1313.593,-325.1472;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;80;-46.40698,666.8528;Inherit;True;Property;_Metallic_Smoothness;Metallic_Smoothness;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;81;-334.407,938.8528;Inherit;False;Property;_Normal_Scale;Normal_Scale;9;0;Create;True;0;0;0;False;0;False;0;1.2;0;15;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;82;353.593,554.8528;Inherit;False;Property;_Smoothness;Smoothness;8;0;Create;True;0;0;0;False;0;False;0.2765529;0.2765529;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;83;1457.593,10.85277;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;84;-46.40698,874.8528;Inherit;True;Property;_Normal;Normal;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;85;-62.40698,1082.853;Inherit;True;Property;_AmbientOcclusion;Ambient Occlusion;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;86;1137.593,522.8528;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;87;1712,64;Inherit;True;Property;_Grunge_ON;Grunge_ON;10;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;84;5;81;0
WireConnection;85;1;68;0
WireConnection;86;0;82;0
WireConnection;86;1;80;4
WireConnection;87;1;78;0
WireConnection;87;0;83;0
WireConnection;37;0;87;0
WireConnection;37;1;84;0
WireConnection;37;4;80;5
WireConnection;37;7;86;0
WireConnection;37;8;85;0
ASEEND*/
//CHKSM=FD8FA178F7C12D741B4893B9C9DF63870FDF7651